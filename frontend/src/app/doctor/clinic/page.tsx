        ...
        <section className="mb-10 rounded-3xl border border-white/20 bg-white/[0.08] p-8 shadow-[0_20px_60px_rgba(0,0,0,0.3)] backdrop-blur-2xl">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            ...
            <button
              ...
              className="inline-flex h-fit rounded-2xl border border-red-300/30 bg-red-500/10 px-5 py-3 text-sm font-semibold text-red-100 transition hover:bg-red-500/20"
            >
              Logout
            </button>
          </div>
            ...
            >
              ...
              <div className="border-b border-white/15 bg-gradient-to-r from-blue-600/75 via-sky-500/65 to-cyan-400/55 p-7 text-white backdrop-blur-xl">
                <div className="flex items-center justify-between">
                  ...
                  <span className="rounded-full border border-white/25 bg-white/15 px-4 py-1.5 text-xs font-bold text-white backdrop-blur-xl">
                    Active Clinic
                  </span>
                </div>
