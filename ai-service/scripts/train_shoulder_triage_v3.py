...
OUTPUT_DIR = AI_SERVICE_DIR / "models" / "shoulder_triage_v3"
...
def main() -> None:
    ...
    """
    model_path = OUTPUT_DIR / "shoulder_triage_v3_model.keras"
    ...
    (OUTPUT_DIR / "shoulder_triage_v3_thresholds.json").write_text(
        json.dumps(
            {
                "threshold": threshold,
